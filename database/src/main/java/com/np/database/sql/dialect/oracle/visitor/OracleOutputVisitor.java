...
import com.np.database.sql.ast.statement.SQLAlterProcedureStatement;
import com.np.database.sql.ast.statement.SQLAlterTableItem;
import com.np.database.sql.ast.statement.SQLAlterTableRename;
import com.np.database.sql.ast.statement.SQLAlterTableStatement;
...
import com.np.database.sql.ast.statement.SQLCreateFunctionStatement;
...
import com.np.database.sql.ast.statement.SQLJoinTableSource;
import com.np.database.sql.ast.statement.SQLJoinTableSource.JoinType;
import com.np.database.sql.ast.statement.SQLRollbackStatement;
import com.np.database.sql.ast.statement.SQLSavePointStatement;
import com.np.database.sql.ast.statement.SQLScriptCommitStatement;
...
import com.np.database.sql.ast.statement.SQLTruncateStatement;
import com.np.database.sql.ast.statement.SQLUnique;
import com.np.database.sql.ast.statement.SQLWithSubqueryClause;
import com.np.database.sql.dialect.oracle.ast.OracleDataTypeIntervalDay;
import com.np.database.sql.dialect.oracle.ast.OracleDataTypeIntervalYear;
import com.np.database.sql.dialect.oracle.ast.clause.CycleClause;
import com.np.database.sql.dialect.oracle.ast.clause.ModelClause;
import com.np.database.sql.dialect.oracle.ast.clause.ModelClause.CellAssignment;
import com.np.database.sql.dialect.oracle.ast.clause.ModelClause.CellAssignmentItem;
import com.np.database.sql.dialect.oracle.ast.clause.ModelClause.CellReferenceOption;
import com.np.database.sql.dialect.oracle.ast.clause.ModelClause.MainModelClause;
import com.np.database.sql.dialect.oracle.ast.clause.ModelClause.ModelColumn;
import com.np.database.sql.dialect.oracle.ast.clause.ModelClause.ModelColumnClause;
import com.np.database.sql.dialect.oracle.ast.clause.ModelClause.ModelRuleOption;
import com.np.database.sql.dialect.oracle.ast.clause.ModelClause.ModelRulesClause;
import com.np.database.sql.dialect.oracle.ast.clause.ModelClause.QueryPartitionClause;
import com.np.database.sql.dialect.oracle.ast.clause.ModelClause.ReferenceModelClause;
import com.np.database.sql.dialect.oracle.ast.clause.ModelClause.ReturnRowsClause;
import com.np.database.sql.dialect.oracle.ast.clause.OracleLobStorageClause;
import com.np.database.sql.dialect.oracle.ast.clause.OracleReturningClause;
import com.np.database.sql.dialect.oracle.ast.clause.OracleStorageClause;
import com.np.database.sql.dialect.oracle.ast.clause.OracleWithSubqueryEntry;
import com.np.database.sql.dialect.oracle.ast.clause.PartitionExtensionClause;
import com.np.database.sql.dialect.oracle.ast.clause.SampleClause;
import com.np.database.sql.dialect.oracle.ast.clause.SearchClause;
import com.np.database.sql.dialect.oracle.ast.expr.OracleAnalytic;
import com.np.database.sql.dialect.oracle.ast.expr.OracleAnalyticWindowing;
import com.np.database.sql.dialect.oracle.ast.expr.OracleArgumentExpr;
import com.np.database.sql.dialect.oracle.ast.expr.OracleBinaryDoubleExpr;
import com.np.database.sql.dialect.oracle.ast.expr.OracleBinaryFloatExpr;
import com.np.database.sql.dialect.oracle.ast.expr.OracleCursorExpr;
import com.np.database.sql.dialect.oracle.ast.expr.OracleDatetimeExpr;
import com.np.database.sql.dialect.oracle.ast.expr.OracleDbLinkExpr;
import com.np.database.sql.dialect.oracle.ast.expr.OracleIntervalExpr;
import com.np.database.sql.dialect.oracle.ast.expr.OracleIsOfTypeExpr;
import com.np.database.sql.dialect.oracle.ast.expr.OracleIsSetExpr;
import com.np.database.sql.dialect.oracle.ast.expr.OracleOuterExpr;
import com.np.database.sql.dialect.oracle.ast.expr.OracleRangeExpr;
import com.np.database.sql.dialect.oracle.ast.expr.OracleSizeExpr;
import com.np.database.sql.dialect.oracle.ast.expr.OracleSysdateExpr;
import com.np.database.sql.dialect.oracle.ast.expr.OracleTreatExpr;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterIndexStatement.Rebuild;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterSessionStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterSynonymStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterTableDropPartition;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterTableModify;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterTableMoveTablespace;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.NestedTablePartitionSpec;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.TableSpaceItem;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterTableSplitPartition.UpdateIndexesClause;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterTableTruncatePartition;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceAddDataFile;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterTablespaceStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterTriggerStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleAlterViewStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleCheck;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleConstraint;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleContinueStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleCreateDatabaseDbLinkStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleCreateIndexStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleCreatePackageStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleCreateSynonymStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleCreateTableStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleCreateTypeStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleDeleteStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleDropDbLinkStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleExceptionStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleExecuteImmediateStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleExitStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleExplainStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleFileSpecification;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleForStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleForeignKey;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleGotoStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleInsertStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleLabelStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleLockTableStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClause;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.ConditionalInsertClauseItem;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleMultiInsertStatement.InsertIntoClause;
import com.np.database.sql.dialect.oracle.ast.stmt.OraclePipeRowStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OraclePrimaryKey;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleRaiseStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleRunStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSelectJoin;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSelectPivot;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSelectPivot.Item;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSelectPivotBase;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSelectQueryBlock;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSelectRestriction;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.CheckOption;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSelectRestriction.ReadOnly;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSelectSubqueryTableSource;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSelectTableReference;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSelectUnPivot;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSetTransactionStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSupplementalIdKey;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleSupplementalLogGrp;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleUnique;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleUpdateStatement;
import com.np.database.sql.dialect.oracle.ast.stmt.OracleUsingIndexClause;
import com.np.database.sql.dialect.oracle.parser.OracleFunctionDataType;
import com.np.database.sql.dialect.oracle.parser.OracleProcedureDataType;
...
//    }
    ...
    @Override
    public void endVisit(com.np.database.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {

    }

    @Override
    public boolean visit(com.np.database.sql.dialect.oracle.ast.stmt.OracleExceptionStatement.Item x) {
        print0(ucase ? "WHEN " : "when ");
        x.getWhen().accept(this);
        print0(ucase ? " THEN" : " then");
...
//    }
    ...
    public boolean visit(OracleCreateDatabaseDbLinkStatement x) {
        ...
        print0(ucase ? "DATABASE LINK " : "orm link ");
