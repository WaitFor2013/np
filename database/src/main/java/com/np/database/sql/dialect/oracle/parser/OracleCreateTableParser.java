...
import com.np.database.sql.ast.statement.SQLExternalRecordFormat;
...
import com.np.database.sql.dialect.oracle.ast.stmt.OracleCreateTableStatement.DeferredSegmentCreation;
...
import com.np.database.sql.parser.SQLCreateTableParser;
