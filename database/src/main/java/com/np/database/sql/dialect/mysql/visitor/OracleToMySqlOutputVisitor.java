...
import com.np.database.sql.dialect.oracle.ast.OracleDataTypeIntervalDay;
import com.np.database.sql.dialect.oracle.ast.OracleDataTypeIntervalYear;
import com.np.database.sql.dialect.oracle.ast.clause.*;
import com.np.database.sql.dialect.oracle.ast.expr.*;
import com.np.database.sql.dialect.oracle.ast.stmt.*;
import com.np.database.sql.dialect.oracle.visitor.OracleASTVisitor;
