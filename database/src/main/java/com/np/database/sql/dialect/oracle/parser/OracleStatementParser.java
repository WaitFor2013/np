...
import com.np.database.sql.ast.SQLPartitionByHash;
import com.np.database.sql.ast.SQLPartitionByRange;
import com.np.database.sql.ast.SQLRecordDataType;
...
import com.np.database.sql.ast.expr.SQLCaseStatement;
...
import com.np.database.sql.ast.statement.SQLAlterFunctionStatement;
import com.np.database.sql.ast.statement.SQLAlterProcedureStatement;
import com.np.database.sql.ast.statement.SQLAlterSequenceStatement;
import com.np.database.sql.ast.statement.SQLAlterTableAddColumn;
import com.np.database.sql.ast.statement.SQLAlterTableAddConstraint;
import com.np.database.sql.ast.statement.SQLAlterTableDisableConstraint;
import com.np.database.sql.ast.statement.SQLAlterTableDropColumnItem;
import com.np.database.sql.ast.statement.SQLAlterTableDropConstraint;
import com.np.database.sql.ast.statement.SQLAlterTableDropIndex;
import com.np.database.sql.ast.statement.SQLAlterTableDropPrimaryKey;
import com.np.database.sql.ast.statement.SQLAlterTableEnableConstraint;
...
import com.np.database.sql.ast.statement.SQLAlterTypeStatement;
...
import com.np.database.sql.ast.statement.SQLCommitStatement;
import com.np.database.sql.ast.statement.SQLCreateFunctionStatement;
import com.np.database.sql.ast.statement.SQLCreateProcedureStatement;
import com.np.database.sql.ast.statement.SQLCreateSequenceStatement;
import com.np.database.sql.ast.statement.SQLDeclareStatement;
import com.np.database.sql.ast.statement.SQLDropMaterializedViewStatement;
import com.np.database.sql.ast.statement.SQLDropProcedureStatement;
import com.np.database.sql.ast.statement.SQLDropSequenceStatement;
import com.np.database.sql.ast.statement.SQLDropSynonymStatement;
import com.np.database.sql.ast.statement.SQLDropTableStatement;
import com.np.database.sql.ast.statement.SQLDropTriggerStatement;
import com.np.database.sql.ast.statement.SQLDropTypeStatement;
import com.np.database.sql.ast.statement.SQLDropUserStatement;
import com.np.database.sql.ast.statement.SQLExprStatement;
...
import com.np.database.sql.ast.statement.SQLReturnStatement;
...
import com.np.database.sql.ast.statement.SQLShowErrorsStatement;
...
import com.np.database.sql.dialect.oracle.ast.stmt.OracleLockTableStatement.LockMode;
...
import com.np.database.sql.dialect.oracle.ast.stmt.OracleStatement;
import com.np.database.sql.parser.LayoutCharacters;
...
import com.np.database.sql.dialect.oracle.ast.clause.OracleReturningClause;
import com.np.database.sql.parser.*;
import com.np.database.sql.util.FnvHash;
import com.np.database.sql.util.JdbcConstants;
