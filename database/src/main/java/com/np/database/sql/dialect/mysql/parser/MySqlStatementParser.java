...
import com.np.database.sql.ast.SQLParameter.ParameterType;
...
import com.np.database.sql.ast.expr.SQLIntervalExpr;
...
import com.np.database.sql.ast.statement.SQLAlterCharacter;
import com.np.database.sql.ast.statement.SQLAlterDatabaseStatement;
...
import com.np.database.sql.ast.statement.SQLAlterTableAddIndex;
import com.np.database.sql.ast.statement.SQLAlterTableAddPartition;
import com.np.database.sql.ast.statement.SQLAlterTableAnalyzePartition;
import com.np.database.sql.ast.statement.SQLAlterTableCheckPartition;
import com.np.database.sql.ast.statement.SQLAlterTableCoalescePartition;
import com.np.database.sql.ast.statement.SQLAlterTableConvertCharSet;
import com.np.database.sql.ast.statement.SQLAlterTableDisableConstraint;
import com.np.database.sql.ast.statement.SQLAlterTableDisableKeys;
import com.np.database.sql.ast.statement.SQLAlterTableDiscardPartition;
...
import com.np.database.sql.ast.statement.SQLAlterTableDropForeignKey;
import com.np.database.sql.ast.statement.SQLAlterTableDropIndex;
import com.np.database.sql.ast.statement.SQLAlterTableDropKey;
import com.np.database.sql.ast.statement.SQLAlterTableDropPartition;
...
import com.np.database.sql.ast.statement.SQLAlterTableEnableKeys;
import com.np.database.sql.ast.statement.SQLAlterTableExchangePartition;
import com.np.database.sql.ast.statement.SQLAlterTableImportPartition;
import com.np.database.sql.ast.statement.SQLAlterTableOptimizePartition;
import com.np.database.sql.ast.statement.SQLAlterTableReOrganizePartition;
import com.np.database.sql.ast.statement.SQLAlterTableRebuildPartition;
import com.np.database.sql.ast.statement.SQLAlterTableRename;
import com.np.database.sql.ast.statement.SQLAlterTableRenameIndex;
import com.np.database.sql.ast.statement.SQLAlterTableRepairPartition;
import com.np.database.sql.ast.statement.SQLAlterTableStatement;
import com.np.database.sql.ast.statement.SQLAlterTableTruncatePartition;
import com.np.database.sql.ast.statement.SQLAlterViewStatement;
...
import com.np.database.sql.ast.statement.SQLCreateDatabaseStatement;
...
import com.np.database.sql.ast.statement.SQLFetchStatement;
...
import com.np.database.sql.ast.statement.SQLShowTablesStatement;
import com.np.database.sql.ast.statement.SQLStartTransactionStatement;
...
import com.np.database.sql.dialect.mysql.ast.clause.ConditionValue;
import com.np.database.sql.dialect.mysql.ast.clause.ConditionValue.ConditionType;
...
import com.np.database.sql.dialect.mysql.ast.clause.MySqlHandlerType;
...
import com.np.database.sql.dialect.mysql.ast.statement.MySqlLockTableStatement.LockType;
...
import com.np.database.sql.parser.EOFParserException;
import com.np.database.sql.parser.InsertColumnsCache;
                ...
                if (lexer.token() == Token.SELECT) {
                    ...
                    if (lexer.token() != Token.RPAREN) {
                        ...
                        if (insertColumnsCache != null && tableName != null) {
                            ...
                            SQLASTOutputVisitor outputVisitor = NpSqlHelper.createOutputVisitor(buf, dbType);
