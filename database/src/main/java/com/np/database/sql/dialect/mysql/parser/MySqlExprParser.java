...
import com.np.database.sql.ast.statement.SQLForeignKeyImpl.Option;
...
import com.np.database.sql.dialect.mysql.ast.expr.MySqlMatchAgainstExpr.SearchModifier;
