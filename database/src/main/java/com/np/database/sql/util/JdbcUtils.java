    ...
    /*static {
        try {
            ...
            if (ctxClassLoader != null) {
                for (Enumeration<URL> e = ctxClassLoader.getResources("sql/driver.properties"); e.hasMoreElements();) {
                    ...
                    DRIVER_URL_MAPPING.putAll(param);
                }
            }
        } catch (Exception e) {
            log.error("load driver.properties error", e);
        }
    }*/
                ...
                if (type == Types.VARCHAR || type == Types.CHAR || type == Types.NVARCHAR || type == Types.NCHAR) {
                    ...
                    if (rs.wasNull()) {
                        ...
                        if (object instanceof byte[]) {
                            ...
                            String text = NpHexBin.encode(bytes);
                            out.print(text);
                        } else {
                            out.print(String.valueOf(object));
                        }
    ...
    public static String getDriverClassName(String rawUrl) throws SQLException {
        ...
        if (rawUrl.startsWith("jdbc:derby:")) {
            ...
            if (mysql_driver_version_6 == null) {
                mysql_driver_version_6 = NpInterUtils.loadClass("com.mysql.cj.jdbc.Driver") != null;
            }
            ...
            return "COM.cloudscape.domain.JDBCDriver";
