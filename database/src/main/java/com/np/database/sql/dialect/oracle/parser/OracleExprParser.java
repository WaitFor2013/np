...
import com.np.database.sql.ast.SQLKeep;
import com.np.database.sql.ast.SQLKeep.DenseRank;
...
import com.np.database.sql.ast.SQLPartitionByList;
import com.np.database.sql.ast.SQLPartitionByRange;
import com.np.database.sql.ast.SQLPartitionValue;
import com.np.database.sql.ast.SQLSubPartition;
import com.np.database.sql.ast.SQLSubPartitionBy;
import com.np.database.sql.ast.SQLSubPartitionByHash;
import com.np.database.sql.ast.SQLSubPartitionByList;
import com.np.database.sql.ast.expr.SQLAggregateExpr;
import com.np.database.sql.ast.expr.SQLAggregateOption;
import com.np.database.sql.ast.expr.SQLArrayExpr;
...
import com.np.database.sql.ast.expr.SQLSequenceExpr;
import com.np.database.sql.ast.expr.SQLTimestampExpr;
import com.np.database.sql.ast.expr.SQLUnaryExpr;
import com.np.database.sql.ast.expr.SQLUnaryOperator;
...
import com.np.database.sql.dialect.oracle.ast.OracleSegmentAttributes;
...
import com.np.database.sql.dialect.oracle.ast.clause.OracleStorageClause.FlashCacheType;
...
import com.np.database.sql.dialect.oracle.ast.expr.OracleIntervalType;
...
import com.np.database.sql.dialect.oracle.ast.stmt.OracleConstraint.Initially;
