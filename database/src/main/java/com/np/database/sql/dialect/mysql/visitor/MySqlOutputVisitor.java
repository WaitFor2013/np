...
import com.np.database.sql.ast.statement.SQLColumnConstraint;
import com.np.database.sql.ast.statement.SQLColumnDefinition;
import com.np.database.sql.ast.statement.SQLCommentStatement;
...
import com.np.database.sql.dialect.mysql.ast.statement.MySqlCreateTableStatement.TableSpaceOption;
import com.np.database.sql.dialect.mysql.ast.statement.MySqlCreateUserStatement;
import com.np.database.sql.dialect.mysql.ast.statement.MySqlCreateUserStatement.UserSpecification;
...
//    }
    ...
    public boolean visit(MySqlShowCreateDatabaseStatement x) {
        print0(ucase ? "SHOW CREATE DATABASE " : "show create orm ");
        x.getDatabase().accept(this);
        return false;
    }
    ...
    public boolean visit(MySqlShowDatabasePartitionStatusStatement x) {
        print0(ucase ? "SHOW DATABASE PARTITION STATUS FOR " : "show orm partition status for ");
        x.getDatabase().accept(this);
        return false;
    }
