...
public class SQLBinaryOpExpr extends SQLExprImpl implements SQLReplaceable, Serializable {
    ...
    public boolean equalsIgoreOrder(SQLBinaryOpExpr other) {
        ...
        return (NpInterUtils.equals(this.left, other.left)
                    && NpInterUtils.equals(this.right, other.right))
                || (NpInterUtils.equals(this.left, other.right)
                    && NpInterUtils.equals(this.right, other.left));
    }
    ...
    public String toString() {
        return NpSqlHelper.toSQLString(this, getDbType());
    }
