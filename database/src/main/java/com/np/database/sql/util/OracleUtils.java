...
public class OracleUtils {
    ...
    public static boolean isBuiltinFunction(String function) {
        ...
        if (functions == null) {
            ...
            NpInterUtils.loadFromFile("sql/oracle/builtin_functions", functions);
    ...
    public static boolean isBuiltinTable(String table) {
        ...
        if (tables == null) {
            ...
            NpInterUtils.loadFromFile("sql/oracle/builtin_tables", tables);
    ...
    public static boolean isKeyword(String name) {
        ...
        if (words == null) {
            ...
            NpInterUtils.loadFromFile("sql/oracle/keywords", words);
            keywords = words;
        }
    ...
    public static String getCreateTableScript(Connection conn, boolean sorted, boolean simplify) throws SQLException {
        ...
        List stmtList = NpSqlHelper.parseStatements(ddlScript, JdbcConstants.ORACLE);
        if (simplify) {
        ...
        return NpSqlHelper.toSQLString(stmtList, JdbcConstants.ORACLE);
    }
}
