...
import static com.np.database.sql.parser.CharTypes.isFirstIdentifierChar;
import static com.np.database.sql.parser.CharTypes.isIdentifierChar;
import static com.np.database.sql.parser.CharTypes.isWhitespace;
import static com.np.database.sql.parser.LayoutCharacters.EOI;
import static com.np.database.sql.parser.SQLParserFeature.KeepComments;
import static com.np.database.sql.parser.SQLParserFeature.OptimizedForParameterized;
import static com.np.database.sql.parser.SQLParserFeature.SkipComments;
import static com.np.database.sql.parser.Token.COLONCOLON;
import static com.np.database.sql.parser.Token.COLONEQ;
import static com.np.database.sql.parser.Token.COMMA;
import static com.np.database.sql.parser.Token.DOT;
import static com.np.database.sql.parser.Token.EOF;
import static com.np.database.sql.parser.Token.EQ;
import static com.np.database.sql.parser.Token.ERROR;
import static com.np.database.sql.parser.Token.LBRACE;
import static com.np.database.sql.parser.Token.LBRACKET;
import static com.np.database.sql.parser.Token.LITERAL_ALIAS;
import static com.np.database.sql.parser.Token.LITERAL_CHARS;
import static com.np.database.sql.parser.Token.LPAREN;
import static com.np.database.sql.parser.Token.RBRACE;
import static com.np.database.sql.parser.Token.RBRACKET;
import static com.np.database.sql.parser.Token.RPAREN;
