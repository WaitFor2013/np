...
package com.np.database.sql.util;
...
public class MySqlUtils {
    ...
    public static boolean isKeyword(String name) {
        ...
        if (words == null) {
            ...
            NpInterUtils.loadFromFile("sql/mysql/keywords", words);
            keywords = words;
        }
    ...
    public static boolean isBuiltinDataType(String dataType) {
        ...
        if (dataTypes == null) {
            ...
            NpInterUtils.loadFromFile("sql/mysql/builtin_datatypes", dataTypes);
    ...
    public static String getCreateTableScript(Connection conn, boolean sorted, boolean simplify) throws SQLException {
        ...
        List stmtList = NpSqlHelper.parseStatements(ddlScript, JdbcConstants.MYSQL);
        if (simplify) {
        ...
        return NpSqlHelper.toSQLString(stmtList, JdbcConstants.MYSQL);
    }
    ...
    public static long getLastPacketReceivedTimeMs(Connection conn) throws SQLException {
        if (class_connectionImpl == null && !class_connectionImpl_Error) {
            try {
                class_connectionImpl = NpInterUtils.loadClass("com.mysql.jdbc.MySQLConnection");
        ...
        if (class_MysqlIO == null && !class_MysqlIO_Error) {
            try {
                class_MysqlIO = NpInterUtils.loadClass("com.mysql.jdbc.MysqlIO");
            } catch (Throwable error){
    ...
    public static Class getCommunicationsExceptionClass() {
        ...
        class_5_CommunicationsException = NpInterUtils.loadClass("com.mysql.jdbc.CommunicationsException");
        if (class_5_CommunicationsException != null) {
            return class_5_CommunicationsException;
        }

        class_6_CommunicationsException = NpInterUtils.loadClass("com.mysql.cj.jdbc.exceptions.CommunicationsException");
        if (class_6_CommunicationsException != null) {
            return class_6_CommunicationsException;
        }
